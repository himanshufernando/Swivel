...
class CustomNewsAdapter: ListAdapter<Article, RecyclerView.ViewHolder>(CustomNewsDiffCallback()) {
...
private class CustomNewsDiffCallback : DiffUtil.ItemCallback<Article>() {
